library(RCurl)
download.file(url="http://d396qusza40orc.cloudfront.net/rprog%2Fdata%2Fspecdata.zip",
...
x<- read.table.url("http://www.biostat.jhsph.edu/~rpeng/leanpub/rprog/chicago_data.zip", header=T)
